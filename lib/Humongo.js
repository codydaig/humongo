 ...
 * @param {object} options - An object of connection Options
 * @returns {Client} client - Returns a Cassandra Client Instance
 */
Humongo.prototype.connect = function(options) {
